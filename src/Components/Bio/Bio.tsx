...
export const Bio = () => {
    ...
    return (
        <Flex id="about" column center className={style.wrapper}>
            ...
            <p id="bio">Since beginning my journey as a web developer nearly 7 years ago, I've done remote work for some great companies, and collaborated with talented people to create web applications for both business and consumer use. I'm quietly confident, naturally curious, and perpetually working on continuing to improve my skills in web development, design, and marketing one problem at a time.</p>
        </Flex>
    );
};
